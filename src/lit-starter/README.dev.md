...
The `index.html` and `src/_sample.ts` provide a sample page using the N3O Sample Component.
...
Create a tag on the master branch following symver conventions and push to Github to trigger build and release of a new version of the [@n3oltd/sample-component](https://www.npmjs.com/package/@n3oltd/sample-component) npm package.