...
Create a tag on the master branch following symver conventions and push to Github to trigger build and release of a new version of the [@n3oltd/checkout-name-form](https://www.npmjs.com/package/@n3oltd/checkout-name-form) npm package.